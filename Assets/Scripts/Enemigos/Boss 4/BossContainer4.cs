...
public class BossContainer4 : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (scripter.GetStatusBossBar()) scripter.BossBarUpdate(Mathf.Clamp01(boss.GetVidas() / 975));
    ...
    {
        if (collision.CompareTag("Desactivador") && contadorEstado == 13)
        {
