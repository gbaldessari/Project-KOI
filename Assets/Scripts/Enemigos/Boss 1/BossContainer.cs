...
public class BossContainer : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (scripter.GetStatusBossBar()) scripter.BossBarUpdate(Mathf.Clamp01(boss.GetVidas() / 550));
    ...
    {
        if (collision.CompareTag("Desactivador") && contadorEstado == 7)
        {
