...
public class BossContainer2 : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (scripter.GetStatusBossBar()) scripter.BossBarUpdate(Mathf.Clamp01(boss.GetVidas() / 700));

        cronometro += Time.deltaTime;
        if (contadorEstado == 0)
        {
            gameObject.GetComponent<Animator>().SetBool("Entrada", true);
            gameObject.GetComponent<Animator>().SetBool("Triangulo Inv", false);
        ...
        if (boss.GetVidas() <= vidas - 100 && contadorEstado == 1)
        {
            ...
            else
            {
                ...
                gameObject.GetComponent<Animator>().SetBool("Entrada", false);
                gameObject.GetComponent<Animator>().SetBool("Triangulo Inv", true);
                gameObject.GetComponent<Animator>().SetBool("Medio", false);
                gameObject.GetComponent<Animator>().SetBool("Reloj", false);
                gameObject.GetComponent<Animator>().SetBool("W", false);
                gameObject.GetComponent<Animator>().SetBool("Salida", false);
        ...
        if (boss.GetVidas() <= vidas - 100 && contadorEstado == 8)
        {
            if (hit)
            {
                IsHit = true;
    ...
    {
        if (collision.CompareTag("Desactivador") && contadorEstado == 9)
        {
